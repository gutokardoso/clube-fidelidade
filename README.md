...
- Nome e telefone são exibidos na mesma opção clicável, sem aparência de botão solto.
- O estado visual é sincronizado imediatamente com a opção escolhida no seletor de público.
