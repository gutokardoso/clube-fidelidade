...
def init_db(db_path=None, seed=True):
    ...
    with connect(target) as conn:
        ...
        # Migração v39: permissões por cliente, LGPD, fila, automações e Wallet.
        if _is_postgres(target):
        ...
        # Migração v39b: templates de comunicação e notificações.
        ...
        # Migração v39: tema de cor individual do cartão por cliente.
        if _is_postgres(target):
