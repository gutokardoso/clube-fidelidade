...
def init_db(db_path=None, seed=True):
    ...
    with connect(target) as conn:
        ...
        # Migração v40: permissões por cliente, LGPD, fila, automações e Wallet.
        if _is_postgres(target):
        ...
        # Migração v40b: templates de comunicação e notificações.
        ...
        # Migração v40: tema de cor individual do cartão por cliente.
        if _is_postgres(target):
